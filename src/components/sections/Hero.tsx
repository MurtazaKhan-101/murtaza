  ...
  return (
    <section className="relative mx-auto h-screen w-full">
      <div className={`absolute inset-0 top-[120px] mx-auto max-w-7xl ${styles.paddingX} flex flex-row items-start gap-5`}>
        ...
        <div className="h-auto z-10"> {/* Added z-index here */}
          ...
          <div className="lg:w-[40%] w-full">
            <h6 className={`${styles.heroSubText} text-white`}>
              ...
              Web Developer focusing on creating user-friendly and visually appealing UI designs,
              along with practical backend solutions to drive innovation
            </h6>
          </div>
        ...
        <div className="h-[100%] z-0 w-[50%] mt-[-50px] sm:block hidden">
