...
const Hero = () => {
  ...
  return (
    <section className={`relative mx-auto h-screen w-full`}>
      ...
      >
        ...
        <div className="h-auto">
          ...
          <h6 className={`${styles.heroSubText} text-white`}>
            I'm <span className="text-[#915EFF]">{config.hero.name}</span>, a skilled Full Stack Web Developer focusing on creating user-friendly and visually appealing UI designs, along with practical backend solutions to drive innovation
          </h6>
          </div>
      ...
      <a href='/Murtaza.pdf' download={'Murtaza.pdf'}
